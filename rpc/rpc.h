...
class rpcs : public chanmgr {
  ...
  // @Junyang. This is the map of lists of per client forgotten requests.
  std::map<unsigned int, std::list<unsigned int> > theForgottens;
  ...
  pthread_mutex_t mutexForgotten; // @Junyang. Protect the forgotten map.
